...
<head>
    ...
    <style>
        ...
        .slim-header {
            ...
            position: sticky; top: 0; z-index: 1000; box-shadow: 0 4px 15px rgba(0,0,0,0.8);
        }
        ...
        <div class="admin-section">
            <div class="iframe-wrapper">
                <div id="loader" class="loading-overlay">
                    ...
                    <div class="loading-text">後台連線中...</div>
                </div>
                <iframe
                    id="admin-frame"
                    src="https://deeplearning101-admin-ciecietaipei.hf.space?__theme=dark"
                    allow="clipboard-read; clipboard-write"
                    onload="this.style.opacity='1'; document.getElementById('loader').style.opacity='0'; setTimeout(()=>{document.getElementById('loader').style.display='none'}, 500);"
                ></iframe>
            </div>
        </div>
    </main>
